...
0.0.0.1 adds many improvements:
...
pref("extensions.httprequester.maxhistory", 25);
pref("extensions.httprequester.url.maxhistory", 15);
pref("extensions.httprequester.contenttype.maxhistory", 15);
pref("extensions.httprequester.header.maxhistory", 15);
